  ...
  return (  
    <main className={classes.content} >
      ...
      <Carousel fade infiniteLoop useKeyboardArrows autoPlay>
        <Carousel.Item style={{ transform: "scale(0.9)"}}>
      ...
      <Grid className={classes.content1} spacing={5} style={{ maxWidth: "85%" }}>
        {products
          .filter((product) => {
            if (searchTerm === "") {
              return product;
          ...
          .map((product) => (
            <Grid item key={product.id} id="pro" style={{minWidth: "25%",  maxWidth: "25%", padding: "10px 10px 10px 10px" }}>
